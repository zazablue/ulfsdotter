...
My argument is that this still leaves a place for persistent interfaces designed by the product team responsible for the service. Even if an agent understands the system perfectly, people will sometimes want to interact with it directly. Delegating is not always the cheapest way to get something done. A good interface can help us work out what we want in the first place. It can also make familiar actions almost effortless.

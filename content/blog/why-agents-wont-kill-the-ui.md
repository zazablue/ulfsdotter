...
My argument is that this still leaves a place for persistent interfaces designed by the product team responsible for the service. Sometimes interacting directly is simply cheaper than delegating. In a niche or complex domain, the product team may also be better placed than a general-purpose agent to decide how a person should move through a task. A stable interface lets the team do that cognitive work once and spread the cost across users and uses. It can help us work out what we want in the first place or make familiar actions almost effortless.
